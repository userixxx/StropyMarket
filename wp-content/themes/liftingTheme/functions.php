...
function blankslate_setup()
{
    ...
    register_nav_menus(array('footer-menu' => esc_html__('Footer Menu', 'blankslate'))); // добавляем меню в подвале
    register_nav_menus(array('category-menu' => esc_html__('Категории', 'blankslate'))); // добавляем категории


    /*
    * Woocommerce
    */
    remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20, 0); // удаляем хлебные крошки 
    ...
    */
    remove_action('woocommerce_before_shop_loop', 'woocommerce_result_count', 20, 0); // удаляем количество из архива
    remove_action('woocommerce_before_shop_loop', 'woocommerce_catalog_ordering', 30, 0); // удаляем сортировку из архива

    remove_action('woocommerce_after_shop_loop_item', 'woocommerce_template_loop_add_to_cart', 10); // удаляем внолпку купить товар
